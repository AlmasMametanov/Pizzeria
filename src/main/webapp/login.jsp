                ...
                <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                    <div class="card bg-dark text-white" style="border-radius: 1rem;">
                        <div class="card-body p-4 text-start">
                            <h3 class="fw-bold mb-2 text-uppercase text-center"><fmt:message key="label.login"/></h3>
                            ...
                            <div class="text-center">
                                <form action="signup.jsp" class="mb-0">
                                    <button class="btn btn-link btn-sm"><fmt:message key="button.signup"/></button>
                                </form>
                            </div>
                        </div>
                    </div>
